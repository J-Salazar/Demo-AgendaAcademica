                    ...
                    <div class="sidebar">
                        ...
                        <nav class="mt-2">
                            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('/admin/home') }}" class="nav-link @yield('link-inicio')">
                                ...
                                <li class="nav-item has-treeview @yield('menu-eventos')">
                                    ...
                                    <ul class="nav nav-treeview ml-3">
                                        <li class="nav-item">
                                            <a href="{{ url('admin/interest') }}" class="nav-link @yield('link-meinteresa')"
                                        ...
                                        <li class="nav-item">
                                            <a href="{{ url('admin/attend') }}" class="nav-link @yield('link-asistire')"
                                        ...
                                        <li class="nav-item">
                                            <a href="{{ url('admin/record') }}" class="nav-link @yield('link-historial')"
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('admin/schedule') }}" class="nav-link @yield('link-miagenda')">
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('admin/profile') }}" class="nav-link @yield('link-perfil')">
